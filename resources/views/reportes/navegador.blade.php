...
<script>
    ...
    var config = {
        ...
        data: {
            ...
            labels: [@foreach ( $valores as $dato ) "{{ $dato->navegador }}", @endforeach]
        },
        options: {
            responsive: true,
            legend: {
    ...
    var config2 = {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Navegador con más Conversiones'
            },
            animation: {
                animateScale: true,
                animateRotate: true,
    ...
    var config3 = {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Navegador con más Ganancias'
            },
            animation: {
                animateScale: true,
                animateRotate: true,
